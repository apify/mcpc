...
| ----------------------------------------------------------------------- | ---------- | ------ | ------ | ----: | ------: | ------: | ----- | --------- | ------- | ----- | ------ | --------- | -------- | ----- | ------------ | --------------- | ----- | ---- | ----------- | ---- | --- |
| **[apify/mcpc](https://github.com/apify/mcpc)**                         | 2026-07-28 | ✅     | TS     |   847 |     758 |      15 | ✅    | ✅        | ✅      | ✅    | ✅     | ✅        | ✅       | ✅    | ✅           | ✅              | ✅    | ✅   | ✅          | ✅   | —   |
| [steipete/mcporter](https://github.com/steipete/mcporter)               | 2026-07-28 | ✅     | TS     |  5.0k |     942 |      51 | ✅    | ✅        | —       | —     | —      | ✅        | ✅       | ✅    | —            | —               | ✅    | ✅   | —           | —    | —   |
| [knowsuchagency/mcp2cli](https://github.com/knowsuchagency/mcp2cli)     | 2025-11-25 | ✅     | Python |  2.4k |     168 |      24 | ✅    | ✅        | ✅      | —     | —      | ✅        | ✅       | ✅    | ✅           | —               | ✅    | ✅   | ✅          | —    | —   |
| [IBM/mcp-cli](https://github.com/IBM/mcp-cli)                           | 2025-06-18 | ✅     | Python |  2.0k |     800 |      23 | ✅    | ✅        | ✅      | —     | —      | ✅        | ✅       | ✅    | —            | —               | ✅    | ✅   | —           | —    | ✅  |
| [f/mcptools](https://github.com/f/mcptools)                             | 2024-11-05 | ⚠️     | Go     |  1.6k |     174 |      16 | ✅    | ✅        | ✅      | —     | —      | ✅        | —        | —     | —            | —               | ✅    | ✅   | —           | —    | —   |
| [philschmid/mcp-cli](https://github.com/philschmid/mcp-cli)             | 2025-11-25 | ⚠️     | TS     |  1.3k |      30 |       3 | ✅    | —         | —       | —     | —      | ✅        | ✅       | —     | —            | —               | ✅    | ✅   | ✅          | —    | —   |
| [adhikasp/mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)   | 2025-06-18 | ⚠️     | Python |   677 |     113 |       5 | ✅    | —         | —       | —     | —      | —         | —        | —     | —            | —               | ✅    | —    | —           | —    | ✅  |
| [thellimist/clihub](https://github.com/thellimist/clihub)               | 2025-11-25 | ⚠️     | Go     |   667 |      60 |       1 | ✅    | —         | —       | —     | —      | —         | —        | ✅    | ✅           | —               | ✅    | ✅   | ✅          | —    | —   |
| [wong2/mcp-cli](https://github.com/wong2/mcp-cli)                       | 2025-11-25 | ⚠️     | JS     |   444 |      67 |       6 | ✅    | ✅        | ✅      | —     | —      | —         | —        | ✅    | —            | —               | ✅    | ✅   | —           | —    | —   |
| [activeing123/mcptoon](https://github.com/activeing123/mcptoon)         | 2026-07-28 | ✅     | Python |   197 |     229 |       3 | ✅    | —         | —       | —     | —      | ✅        | —        | —     | —            | —               | ✅    | ✅   | —           | —    | —   |
| [mcpshim/mcpshim](https://github.com/mcpshim/mcpshim)                   | 2025-11-25 | ✅     | Go     |    64 |      17 |       1 | ✅    | —         | —       | —     | —      | ✅        | ✅       | ✅    | —            | —               | —     | ✅   | ✅          | —    | —   |
| [lydakis/mcpx](https://github.com/lydakis/mcpx)                         | 2026-07-28 | ✅     | Go     |    52 |     119 |       3 | ✅    | —         | —       | —     | —      | ✅        | ✅       | ✅    | —            | —               | ✅    | ✅   | —           | —    | —   |
| [evantahler/mcpx](https://github.com/evantahler/mcpx)                   | 2026-07-28 | ✅     | TS     |    33 |     116 |       1 | ✅    | ✅        | ✅      | ✅    | —      | ✅        | —        | ✅    | —            | —               | ✅    | ✅   | ✅          | —    | —   |
| [EstebanForge/mcp-cli-ent](https://github.com/EstebanForge/mcp-cli-ent) | 2026-07-28 | ✅     | Go     |    15 |      61 |       3 | ✅    | —         | —       | —     | —      | ✅        | ✅       | —     | —            | —               | ✅    | ✅   | ✅          | —    | —   |
| [domdomegg/call-mcp](https://github.com/domdomegg/call-mcp)             | 2025-11-25 | ✅     | TS     |     3 |      37 |       3 | ✅    | —         | —       | —     | —      | ✅        | —        | ✅    | —            | —               | ✅    | ✅   | —           | —    | —   |
...
- [f/mcptools](https://github.com/f/mcptools) depends on a Go MCP library capable of `2025-03-26`, but its own client code hardcodes `2024-11-05` (its README notes HTTP/SSE support is limited to that version).
- MCP versions for [knowsuchagency/mcp2cli](https://github.com/knowsuchagency/mcp2cli) and [adhikasp/mcp-client-cli](https://github.com/adhikasp/mcp-client-cli) reflect their locked/tested SDK version; both allow a looser dependency range that could resolve to a newer SDK on a fresh install.
