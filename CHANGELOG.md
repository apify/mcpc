...
- x402 auto-pay no longer signs when the PAYMENT-REQUIRED `resource.url` is unreachable (timeout, DNS, or connection error). Ghost 402s used to settle against a dead host. (#396)
